...
<section id="section-2">
    <div class="bg-white h-full relative">
        ...
        <h1 class="text-stone-800 text-6xl pt-2 pb-32 font-bold text-center ">Warta Paroki</h1>
        <h1 class="text-stone-800 max-xs:text-5xl max-sm:pr-0.5 max-sm:pl-0.5 max-sm:text-5xl md:text-5xl lg:text-7xl pr-32 pl-32 pt-2 pb-2 font-bold text-center ">{{ $wartaParoki->Judul }}</h1>
        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-stone-800 text-center mt-8">
        {{ $wartaParoki->TanggalUpload }}
        </h1>
