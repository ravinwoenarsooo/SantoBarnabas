...
<body>
    <div class="bg-white" style="background-image: url('{{ asset('images/Rectangle.png') }}');
            ...
            <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col" bis_skin_checked="1">
                ...
                <p class="text-sm text-white font-bold sm:ml-2 sm:mt-0 mt-4 mr-4">santobarnabas@gmail.com</p>
                <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
                    <img src="{{ asset('images/phone.png') }}" alt="Phone Logo" class="w-6 h-auto">
                </a>
                <p class="text-sm text-white font-bold sm:ml-2 sm:mt-0 mt-4">+62 123 4567 8901</p>
                <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                    <a href="https://www.youtube.com/@KomsosBarnabas" class="ml-3 text-white">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-auto" viewBox="0 0 24 24">
                    ...
                    <a href="https://www.instagram.com/komsossantobarnabas/" class="ml-3 text-white">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-auto" viewBox="0 0 24 24">
