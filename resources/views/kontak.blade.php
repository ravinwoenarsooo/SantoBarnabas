    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap -mx-4 lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                ...
                <h2 class="text-black mb-6 text-5xl font-bold">
                    Kontak Kami
                </h2>
                <p class="text-base leading-relaxed text-body-color mb-9">
                    Dibawah ini adalah informasi lengkap mengenai 
                    kontak Gereja Katolik Santo Barnabas. Hubungi kami, atau kirim
                    pesan melalui form dihalaman ini.
                </p>
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div class="w-full">
                        <h4 class="mb-1 text-xl font-bold text-blac">
                            Email Paroki
                        </h4>
                        <p class="text-base text-body-color">
                            parokipamulang@gmail.com
                        </p>
                        <p class="text-base text-body-color">
                            parokisantobarnabas@gmail.com
                        </p>
                    </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div class="relative p-8 bg-white rounded-lg shadow-lg sm:p-12" >
                    <form>
                        ...
                        <div>
                            <button type="submit" class="w-full p-3 text-black transition border rounded border-primary bg-primary hover:bg-opacity-90 font-medium" >
                            Send Message
                            </button>
                        </div>
                    </form>
