...
<section id="section-2">
    ...
    <hr class="border-b-2 border-stone-500 mx-auto w-90 mb-10">
        <h1 class="text-stone-800 text-6xl pt-20 font-montserrat font-bold text-center ">Paroki Pamulang Gereja Santo Barnabas</h1>
        <h1 class="title-font sm:text-3xl text-2xl mb-4 font-medium text-stone-800 text-center mt-4">
            "Karena Perintah-Mu akan kutebarkan jalaku"
        </h1>
        <div class="mx-auto w-full flex px-5 py-12 md:flex-col flex-col items-center ">
            ...
            <div class="xl:flex-col md:w-3/4 w-full xl:pl-12 md:pl-8 flex flex-col md:items-start md:text-left items-center text-center relative z-20">
        ...
        <div class="mx-auto w-full px-10 py-12 md:flex-col items-center flex justify-center">
    <img class="object-cover w-100 h-auto object-center rounded" alt="Your Image Description" src="{{ asset('images/peta.png') }}">
</div>
